...
print('VC feature SVM accuracy = ',clf.score(test_trans2,test_Y))
# Logistic Regression
...
print('VC feature RF accuracy = ',rf.score(test_trans2,test_Y))
...
# Plot outputs
# plt.scatter(test_X, test_Y,  color='red',s=1)
# plt.scatter(test_X, predict_Y, color='blue',s=1)
#
# plt.xticks(())
# plt.yticks(())
# plt.show()